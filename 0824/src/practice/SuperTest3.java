...
class Sub1 extends SD1 {
	public Sub1(int i1) {   //  생성자. 매개변수 int
		super(i1);     //  상위 생성자 i1에 접근
		System.out.println("Sub1(int i1) 생성자 수행");
		this.i1 = this.i1 * i1 ;
		System.out.println(i1 +"의 3제곱은 : "+this.i1);
	}

	public Sub1(double d1) {  //  생성자. 매개변수 double
		super(d1);     //   상위 생성자 i1에 접근
...
public class SuperTest3 {
	public static void main(String args[]) {
		Sub1 sub1 = new Sub1(10);   //   1000
		Sub1 sub2 = new Sub1(10.5);   //   110.25, 1157.625
	}
}
